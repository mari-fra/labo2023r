...
PARAM$dataset <- "data_concat.csv"

# valores posibles
#  "MachineLearning"  "EstadisticaClasica" "Ninguno"
PARAM$metodo <- "Frollmean"
PARAM$home <- "~/Documents/MaestriaAustral/LaboratorioI/LabI/labo2023r/LabI/"
...
Corregir_EstadisticaClasica <- function(dataset) {
  ...
  CorregirCampoMes("mprestamos_personales", c(202107, 202109))
}
...
CorregirCampoMes_frollmean_compl <- function(pcampo, pmeses) {
  tbl <- dataset[, list(
    "v1" = shift(get(pcampo), 2, type = "lag"),
    "v2" = shift(get(pcampo), 2, type = "lead"),
...
Corregir_Frollmean_4 <- function(dataset) {
  ...
  CorregirCampoMes_frollmean_compl("mprestamos_personales", c(201801, 201910, 202006, 202107, 202109))
}
...
dir.create(paste0("/home/marifra/Documents/MaestriaAustral/LaboratorioI/LabI/labo2023r/LabI/exp/", PARAM$experimento, "/"), showWarnings = TRUE, recursive = TRUE)
# Establezco el Working Directory DEL EXPERIMENTO
setwd(paste0("/home/marifra/Documents/MaestriaAustral/LaboratorioI/LabI/labo2023r/LabI/exp/", PARAM$experimento, "/"))
...
switch(PARAM$metodo,
  ...
  "Frollmean"           = Corregir_Frollmean_4(dataset)
)
