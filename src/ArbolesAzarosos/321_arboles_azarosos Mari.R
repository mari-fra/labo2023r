...
setwd("/home/marifra/Documents/MaestriaAustral/LaboratorioI/LabI") # Establezco el Working Directory

parametros <- read.csv("labo2023r/src/ArbolesAzarosos/Parametros.csv")
...
for (i in 1:77) {
  ...
  PARAM$num_trees_max <- p[,4]
  print(p[4])

  aux <- aux + 1 
  PARAM$experimento <- aux
